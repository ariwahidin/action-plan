...
class Phpmailer
{
    ...
    public function preSend()
    {
        try {
            ...
            // createBody Mei have added some headers, so retain them
     ...
     * You should only do this to plain-text bodies as wrapping HTML tags Mei break them.
    ...
    public function getMailMIME()
    {
        ...
        if ($this->Encoding != '7bit') {
            // RFC 2045 section 6.4 says multipart MIME parts Mei only use 7bit, 8bit or binary CTE
            if ($ismultipart) {
